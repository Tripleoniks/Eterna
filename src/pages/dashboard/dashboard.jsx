  ...
  return (
    <div className="dashboard">
      ...
      <div className="flex-card">
        {chartDatax.map(
          ({ title, overallPercent, icon, sTitle, chart, keys }, index) => {
            return (
              <div className="item" key={index}>
                ...
                <div className="pie-chart">
                  <PieChart
                    data={[
                      { title: "expired", value: 17, color: "#FA0000" },
                      { title: "valid", value: 57, color: "rgba(0, 110, 51, 0.8)" },
                      { title: "expiring", value: 26, color: "#F9C636" },
                    ]}
                  />
      ...
      <div className="bottom">
        ...
        <div className="btn-wrap">
          <div className="btn-item">
            <button id="btn1st">All Licenses</button>
            <button style={{ backgroundColor: "#FA0000" }}>Approach</button>
            <button style={{ backgroundColor: "#E2B32E" }}>Fulfil</button>
            <button style={{ backgroundColor: "#338B5C" }}>Closed</button>
          </div>
        </div>
          ...
          <div className="show">
            ...
            <div className="select">
              <select onChange={(e) => setRowShown(e.target.value)} id="list">
                <option selected value={tableData.length}>
                  All
                </option>
          ...
          <table className="blueTable">
            ...
            <tbody>
              {tableData
                ...
                .map(({ entities, lincense, agency, fieldOffice }, index) => {
                  return (
                    <tr key={index}>
                      <td>{entities}</td>
                      <td>{lincense}</td>
